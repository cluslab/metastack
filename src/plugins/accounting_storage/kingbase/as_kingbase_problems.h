/*****************************************************************************\
 *  as_kingbase_problems.h - functions for finding out problems in the
...
#ifndef _HAVE_KINGBASE_PROBLEMS_H
#define _HAVE_KINGBASE_PROBLEMS_H
...
extern int as_kingbase_user_no_assocs_or_no_uid(
	kingbase_conn_t *kingbase_conn, slurmdb_assoc_cond_t *assoc_cond,
	List ret_list);
