/*****************************************************************************\
 *  as_kingbase_jobacct_process.h - functions the processing of
...
#ifndef _HAVE_KINGBASE_JOBSLURMDB_PROCESS_H
#define _HAVE_KINGBASE_JOBSLURMDB_PROCESS_H
...
extern List as_kingbase_jobacct_process_get_jobs(kingbase_conn_t *kingbase_conn, uid_t uid,
					   slurmdb_job_cond_t *job_cond);
