/*****************************************************************************\
 *  as_kingbase_qos.h - functions dealing with qos.
 *****************************************************************************
...
#ifndef _HAVE_KINGBASE_QOS_H
#define _HAVE_KINGBASE_QOS_H

#include "accounting_storage_kingbase.h"

extern bool checkIfResultIsNull(KCIResult *result, int num_row);

extern int as_kingbase_add_qos(kingbase_conn_t *kingbase_conn, uint32_t uid, List qos_list);
