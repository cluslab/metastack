...
/**
 * if 3.0, base 23.11
 * define SLURM_PROTOCOL_VERSION META_3_0_PROTOCOL_VERSION
 * // define SLURM_MIN_PROTOCOL_VERSION META_2_0_PROTOCOL_VERSION
 * the minimum supported version should be the official version(22.05 not)
 * define SLURM_MIN_PROTOCOL_VERSION SLURM_22_05_PROTOCOL_VERSION
 * 
 * if 2.1
 * define SLURM_PROTOCOL_VERSION META_2_1_PROTOCOL_VERSION
 */
#define SLURM_PROTOCOL_VERSION META_2_2_PROTOCOL_VERSION

#define SLURM_ONE_BACK_PROTOCOL_VERSION SLURM_21_08_PROTOCOL_VERSION
#define SLURM_MIN_PROTOCOL_VERSION SLURM_20_11_PROTOCOL_VERSION
#else

#define SLURM_PROTOCOL_VERSION SLURM_22_05_PROTOCOL_VERSION
#define SLURM_ONE_BACK_PROTOCOL_VERSION SLURM_21_08_PROTOCOL_VERSION
#define SLURM_MIN_PROTOCOL_VERSION SLURM_20_11_PROTOCOL_VERSION
#endif
