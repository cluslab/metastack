...
static void _pack_update_lics_msg(slurm_license_info_t * msg, buf_t *buffer,
                          	uint16_t protocol_version);
static int _unpack_update_lics_msg(slurm_license_info_t ** msg, buf_t *buffer,
                          	uint16_t protocol_version);
#endif

#ifdef __METASTACK_NEW_LICENSE_OCCUPIED
static void _pack_lics_info_msg(slurm_license_info_t * msg, buf_t *buffer,
                                uint16_t protocol_version);
static int _unpack_lics_info_msg(slurm_license_info_t **msg, 
			     ...
			     uint16_t protocol_version)
{
	...
	*msg = tmp_ptr;
	...
	if (protocol_version >= SLURM_MIN_PROTOCOL_VERSION) {
		...
		safe_unpackstr_xmalloc(&tmp_ptr->priority_weight_tres, &uint32_tmp, buffer);
#endif
	}
...
#ifdef __METASTACK_NEW_LICENSE_OCCUPIED
static void
_pack_update_lics_msg(slurm_license_info_t * msg, buf_t *buffer,
			  uint16_t protocol_version)
{
	_pack_lics_info_msg((slurm_license_info_t *) msg,
				buffer, protocol_version);
}

static int
_unpack_update_lics_msg(slurm_license_info_t ** msg, buf_t *buffer,
                          uint16_t protocol_version)
{
	return _unpack_lics_info_msg((slurm_license_info_t **) msg,
				buffer, protocol_version);
}
#endif
	...
	uint16_t protocol_version)
{
	...
	if ((protocol_version >= META_2_3_PROTOCOL_VERSION) 
		...
		// packbool(msg->enbale_all_nodes, buffer);
	} else if(protocol_version >= SLURM_21_08_PROTOCOL_VERSION) {
#else
	if (protocol_version >= SLURM_21_08_PROTOCOL_VERSION) {
#endif
	...
	uint16_t protocol_version)
{
	...
	*msg = tmp_ptr;
	...
	if ((protocol_version >= META_2_3_PROTOCOL_VERSION)
		...
		safe_unpackstr_xmalloc(&tmp_ptr->watch_dog, &uint32_tmp,
				       buffer);
		// safe_unpackstr_xmalloc(&tmp_ptr->watch_dog_script, &uint32_tmp,
		// 		       buffer);
		// safe_unpack32(&tmp_ptr->init_time, buffer);
		// safe_unpack32(&tmp_ptr->period, buffer);
		// safe_unpackbool(&tmp_ptr->enbale_all_nodes, buffer);
	} else if (protocol_version >= SLURM_21_08_PROTOCOL_VERSION) {
#else
	if (protocol_version >= SLURM_21_08_PROTOCOL_VERSION) {
#endif
	...
	uint16_t protocol_version)
{
	...
	*msg = tmp_ptr;
	...
	if ((protocol_version >= META_2_3_PROTOCOL_VERSION)
		...
		safe_unpackstr_xmalloc(&tmp_ptr->watch_dog, &uint32_tmp, buffer);
		safe_unpackstr_xmalloc(&tmp_ptr->watch_dog_script, &uint32_tmp, buffer);
		safe_unpack32(&tmp_ptr->init_time, buffer);
		safe_unpack32(&tmp_ptr->period, buffer);
			       ...
			       uint16_t protocol_version)
{
    ...
    if (protocol_version >= SLURM_22_05_PROTOCOL_VERSION) {
        if (protocol_version >= META_2_3_PROTOCOL_VERSION) {
			...
			safe_unpackstr_xmalloc(&part->priority_weight_tres, &uint32_tmp, buffer);														
#endif
			       ...
			       uint16_t protocol_version)
{
    ...
    if (protocol_version >= SLURM_22_05_PROTOCOL_VERSION) {
        if (protocol_version >= META_2_3_PROTOCOL_VERSION) {
            safe_unpackstr_xmalloc(&watch_dog->watch_dog, &uint32_tmp, buffer);
            if (watch_dog->watch_dog == NULL)
                watch_dog->watch_dog = xmalloc(1);/* part->name = "" implicit */
			safe_unpackstr_xmalloc(&watch_dog->account, &uint32_tmp, buffer);			
			safe_unpackstr_xmalloc(&watch_dog->script, &uint32_tmp, buffer);
			safe_unpackstr_xmalloc(&watch_dog->describe, &uint32_tmp, buffer);		
...
#endif	
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION	
			safe_unpackstr_xmalloc(&job_desc_ptr->watch_dog,
						&uint32_tmp, buffer);
#endif
#ifdef __METASTACK_NEW_APPTYPE_RECOGNITION
			safe_unpackstr_xmalloc(&job_desc_ptr->apptype,
				       &uint32_tmp, buffer);
#endif
        } else {
			job_desc_ptr = xmalloc(sizeof(job_desc_msg_t));
					    ...
					    uint16_t protocol_version)
{
	...
	*msg_ptr = msg;
	...
	#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
			safe_unpackstr_xmalloc(&msg->watch_dog, &uint32_tmp,
				       buffer);
			safe_unpackstr_xmalloc(&msg->watch_dog_script, &uint32_tmp,
						buffer);
	...
	if (protocol_version >= SLURM_22_05_PROTOCOL_VERSION) {
		if (protocol_version >= META_2_3_PROTOCOL_VERSION) {
			...
			safe_unpackstr_xmalloc(&launch_msg_ptr->user_name, &uint32_tmp,
						buffer);
	#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
			safe_unpackstr_xmalloc(&launch_msg_ptr->watch_dog, &uint32_tmp,
				       buffer);
			safe_unpackstr_xmalloc(&launch_msg_ptr->watch_dog_script, &uint32_tmp,
						buffer);
...
{
	packstr(msg->name, buffer);
	packstr(msg->server, buffer);
	pack32(msg->total, buffer);
	pack32(msg->in_use, buffer);
	pack32(msg->available, buffer);
	pack32(msg->occupied, buffer);
	pack8(msg->remote, buffer);
	pack32(msg->reserved, buffer);
}
static int _unpack_lics_info_msg(slurm_license_info_t **msg, buf_t *buffer,
				uint16_t protocol_version)
{
	uint32_t uint32_tmp = 0;
	slurm_license_info_t *msg_ptr = xmalloc(sizeof(slurm_license_info_t));
	
	*msg = msg_ptr;
	safe_unpackstr_xmalloc(&msg_ptr->name, &uint32_tmp, buffer);
	safe_unpackstr_xmalloc(&msg_ptr->server, &uint32_tmp, buffer);
	safe_unpack32(&msg_ptr->total, buffer);
	safe_unpack32(&msg_ptr->in_use, buffer);
	safe_unpack32(&msg_ptr->available, buffer);
	safe_unpack32(&msg_ptr->occupied, buffer);
	safe_unpack8(&msg_ptr->remote, buffer);
	safe_unpack32(&msg_ptr->reserved, buffer);
	
	return SLURM_SUCCESS;

unpack_error:
	slurm_free_lics_info_msg(msg_ptr);
	*msg = NULL;
	return SLURM_ERROR;
}
#endif
            ...
            for (int i = 0; i < msg->num_lic; i++) {
...
#ifdef __METASTACK_NEW_LICENSE_OCCUPIED
                safe_unpack32(&msg->lic_array[i].occupied, buffer);
                ...
                */
                if (msg->lic_array[i].total < msg->lic_array[i].in_use)
                    ...
                    if (0 == msg->lic_array[i].total)
                        msg->lic_array[i].available = 0;
                    else 
                        msg->lic_array[i].available =
                        msg->lic_array[i].total -
                        MAX(msg->lic_array[i].in_use, msg->lic_array[i].occupied);
                }
#else
                if (msg->lic_array[i].total < msg->lic_array[i].in_use)
                    msg->lic_array[i].available = 0;
...
pack_msg(slurm_msg_t const *msg, buf_t *buffer)
{
	...
	case REQUEST_UPDATE_LICENSE:
		_pack_update_lics_msg((slurm_license_info_t *) msg->
					data, buffer,
					msg->protocol_version);
		break;
#endif
...
#ifdef __METASTACK_NEW_LICENSE_OCCUPIED
	case REQUEST_UPDATE_LICENSE:
		rc = _unpack_update_lics_msg((slurm_license_info_t **) &
						(msg->data), buffer, 
						msg->protocol_version);
		break;
#endif
